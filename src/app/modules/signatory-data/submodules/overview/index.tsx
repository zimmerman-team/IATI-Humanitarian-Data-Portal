...
export function OverviewPage(props) {
  ...
  React.useEffect(() => {
    ...
    const sigdataoverviewhumcallValues = {
      values: {
        q: `reporting_org_ref:${decodeURIComponent(props.match.params.code)} AND (humanitarian:1 OR transaction_humanitarian:1 OR sector_vocabulary:1 OR (-sector_vocabulary:* AND sector_code:[70000 TO 79999]))`,
