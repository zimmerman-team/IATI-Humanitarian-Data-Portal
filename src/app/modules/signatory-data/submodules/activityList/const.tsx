...
export const activitiesQuery = (
  ...
  return {
    ...
    fl: `iati_identifier,activity_status_code,title,title_narrative_text,recipient_country_code,transaction_recipient_country_code,activity_date_start_actual,activity_date_end_actual,result_type,activity_date_start_planned,activity_date_end_planned`,
  };
};
